...
const APPS = [
  ...
  {
    category: 'ai', name: 'محلّل النسب المالية الذكي', icon: '📈', tile: 'tile-c1',
    desc: 'أدخل أرقام قوائمك المالية مرة واحدة، واحصل فوراً على نسب الربحية والسيولة مع تصنيف كل نسبة وتفسير نصي مركّب — قواعد ثابتة بلا أي حفظ لبياناتك.',
    status: 'ready', link: 'financial-ratios.html', linkText: 'افتح الأداة ←'
  },
